define([
    ...
    var ManifestationPaginationView = Backbone.View.extend({
        el: '#manifestation-pagination',
        events: {
        ...
        initialize: function() {
            this.template = _.template($('#manifestation-pagination-template').html());
    ...
    return ManifestationPaginationView;
});
